...
const saveProducts = array => {
  db.serialize(() => {
    ...
    for (let i = 0; i < array.length; i++) {
      stmt.run(array[parseInt(i)].rank, array[parseInt(i)].name, array[parseInt(i)].coverImage, array[parseInt(i)].brandAuthor, array[parseInt(i)].price, array[parseInt(i)].rating_total, array[parseInt(i)].rating_value, array[parseInt(i)].category);
    }
